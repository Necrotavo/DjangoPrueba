...
class Estudiante(models.Model):
    ...
    Estado = models.CharField(max_length=2,choices=ESTADO_ESTUDIANTE)
    Proyecto = models.ForeignKey(Proyecto, on_delete=models.CASCADE)
    Pasantia = models.ForeignKey(Pasantia, on_delete=models.CASCADE, null=True)
